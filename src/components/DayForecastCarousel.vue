<template>
  <div class="day-forecast">
    <h2 class="day-forecast__header">
      Прогноз на {{ card.forecast.forecastday.length }} дня
    </h2>
    <swiper
      class="day-carousel"
      :slidesPerView="2"
      ...
      >
        ...
        <div class="day-carousel-slide__main">
          <div class="day-carousel-slide__average">
            ...
            <img
              class="day-carousel-slide__average-img"
          ...
          <div class="day-carousel-slide__facts">
            <div class="day-carousel-slide__facts-item">
              <img
                class="day-carousel-slide__facts-image"
